...
-- Print all countries affected by hurricanes:
SELECT L.Name AS Country, H.Name AS Hurricane
FROM Hurricane_Affects HA
JOIN Location L ON HA.Country_id = L.Country_id
JOIN Hurricane H ON HA.Event_id = H.Event_id;
